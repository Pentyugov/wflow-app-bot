...
import com.pentyugov.wflow.telbot.application.web.rest.payload.request.TelbotLoginUserRequest;
import com.pentyugov.wflow.telbot.application.web.rest.payload.request.TelbotUpdateUserSettingsRequest;
import com.pentyugov.wflow.telbot.application.web.rest.payload.request.TelbotVerifyCodeRequest;
import com.pentyugov.wflow.telbot.application.web.rest.payload.response.TelbotLoggedUsersResponse;
import com.pentyugov.wflow.telbot.application.web.rest.payload.response.TelbotLoginUserResponse;
import com.pentyugov.wflow.telbot.application.web.rest.payload.response.TelbotVerifyCodeResponse;
...
import static com.pentyugov.wflow.telbot.application.bot.keyboard.InlineKeyboardConstants.CallbackQueryAction.*;
